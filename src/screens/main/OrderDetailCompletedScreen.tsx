...
export default function OrderDetailCompletedScreen({ navigation }: any) {
    ...
    <View style={s.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 16, paddingBottom: 120, gap: 16 }}>
        <View style={s.infoCard}>
          ...
          <TouchableOpacity style={s.downloadBtn} activeOpacity={0.85} onPress={() => navigation.navigate('ViewReport')}>
...
const s = StyleSheet.create({
  ...
  downloadBtn: { marginTop: 14, backgroundColor: Colors.primaryDark, borderRadius: 60, paddingVertical: 14, alignItems: 'center' },
  ...
  divider: { height: 1, backgroundColor: '#E6E6E6', marginTop: 6, opacity: 0.8 },
});
